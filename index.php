					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li><a href="" class="scroll">Contactenos</a></li>
							</ul>
							<div class="clearfix"> </div>							
						</div>	
					</nav>		
			...
			<div style="margin-top: 11px;" data-aos="zoom-out-up">
					...
					<div class="agileits-icon-grid container_object">
						...
						<div class="icon-right">
							...
							<p>1) aquella experiencia que aumente el conocimiento a partir de lecciones aprendidas; <br> 2) que funcione como mecanismo continuo de aprendizaje <br> 3) que considere aspectos de retroalimentación, reflexión y análisis.</p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="agileits-icon-grid container_object"  >
						...
						<div class="icon-right">
							...
							<p>Durante estos últimos años nos hemos consolidado como una empresa que apoya el crecimiento tecnológico de nuestros clientes. Fieles a nuestros principios operativos, nos hemos enfocado en robustecer los Productos y Servicios, siempre buscando los mejores Beneficios al Cliente, lo cual se refleja en la calidad de los Proyectos Realizados.  .</p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="agileits-icon-grid container_services_down">
						...
						<div class="icon-right">
							<h5>Tecnología de Información - IT.</h5>
							<p>Integración de datos, personas, tecnologías y procesos para cumplir con una estrategia administrativa o favorecer una ventaja competitiva en una organización.</p>
						</div>
						<div class="clearfix"> </div>
					</div>
				</div>
	...
	<!--<div class="gallery" id="gallery">
		...
		<div class="gallery-grids">
				...
				<div class="gallery-top-grids">
					...
					<div class="col-sm-3 gallery-grids-left">
						<div class="gallery-grid">
							<a class="example-image-link" href="images/g10.jpg" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae cursus ligula">
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header"> 
								...
								<h4 class="modal-title">Swim Care</h4>
							</div> 
		...
		<div class="container">
			...
			<div class="contact-form">
				...
				<form action="#" method="post">
					...
					<button class="btn1 hvr-sweep-to-bottom">Submit</button>
				</form>
			</div>
		</div>
	</div>
			...
			<div class="container">
				<div class="footer-grids" style="text-align: center; display: block;margin: 0 auto;">
					...
					<div class="agile-footer-grid" style="display: inline-block; width: 32%;float: left;">
						<h3>Contactenos</h3>
						<div id="contJormos" style="color: #A7A5A5; cursor: pointer; margin-top: 15px;" ><button type="button" data-toggle="modal" data-target="#myModalJormos" style="border: none;background: none;" >Jorge Mosquera</button></div>
						<div id="contCharles" style="color: #A7A5A5; cursor: pointer; margin-top: 15px;"><button type="button" data-toggle="modal" data-target="#myModalCharles" style="border: none;background: none;" >Charles Chaderton</button></div>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="modal fade" id="myModalJormos" role="dialog">
	    <div class="modal-dialog">
	      ...
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
	        	<p style="text-align: center; color: #000000;">CDO - Cief Development Officer</p>
	        	<div style="width: 100%; display: block;text-align: center">
	        		<div style="width: 6%; display: inline-block;" >
	        			<img src="static/images/smartphone-call.png" />
	        		</div>
	          		<p style="text-align: center; color: #000000;display: inline-block;">+58-414-4460910</p>
	          	</div>
	          	<div id="emailSendJormos" style="width: 100%; display: block;text-align: center;cursor: pointer">
	        		<div style="width: 6%; display: inline-block;" >
	        			<img src="static/images/envelope.png" />
	        		</div>
	          		<p style="text-align: center; color: #000000;display: inline-block;">jorge.mosquera@mpitca.com.ve</p>
	          	</div>
	          <div id="containerSendEmailJormos" class="labelHide" style="width: 100%;margin: 0 auto;text-align: center;" >
	          	<div>
	  ...
	  <div class="modal fade" id="myModalCharles" role="dialog">
	    <div class="modal-dialog">
	      ...
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
	        	<p style="text-align: center; color: #000000;">CIO - Cief Development Officer</p>
	          <div style="width: 100%; display: block;text-align: center">
	        		<div style="width: 6%; display: inline-block;" >
	        			<img src="static/images/smartphone-call.png" />
	        		</div>
	          		<p style="text-align: center; color: #000000;display: inline-block;">+58-414-4225146</p>
	          	</div>
	          	<div id="emailSendCharles" style="width: 100%; display: block;text-align: center;cursor: pointer">
	        		<div style="width: 6%; display: inline-block;" >
	        			<img src="static/images/envelope.png" />
	        		</div>
	          		<p style="text-align: center; color: #000000;display: inline-block;">charles.chaderton@mpitca.com.ve</p>
	          	</div>
	          <div id="containerSendEmailCharles" class="labelHide" style="width: 100%;margin: 0 auto;text-align: center;" >
	          	<div>
		          	<input style="width: 55%" type="text" placeholder="De:" value="" />
		          	<input style="width: 55%" type="text" placeholder="email:" value="" />
		          	<textarea style="width: 55%;height: 100px;" placeholder="Contenido"  ></textarea>
