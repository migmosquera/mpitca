	...
	<div class="banner banner_interno">
		...
		<div class="container_servicios">
			<div style="display: block">
				...
				<h4 class="container_title_services" style="background-image: url('static/images/fondo.png')" >Objetividad e Independencia</h4>
                                <div class="textInformation">
					<strong>MPIT</strong> 
	              	no está ligada a ningún fabricante, operador ni empresa instaladora, lo que nos permite garantizar la objetividad 
