...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="static/css/nosotros.css" type="text/css" media="all" />
    </head>
                        ...
                        <nav class="navbar navbar-default">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a class="active" href="nosotros.php" class="scroll">Sobre Nosotros</a></li>	
        ...
        <div class="container_contac_me" >
            <div class="container_servicios">
                <div style="display: block">
                    ...
                    <h3 class="title_serivicios"  >Sobre Nosotros</h3>	
                    <div class="linea_degradada_derecha"></div>
                </div>
                <div class="container_content_servicess">
                    <img style="display: inline-block; margin-right: 18px;" src="static/images/mano.png" />
                    <p class="text_nosotros"><strong>Mejores Prácticas en IT, C.A. (MPIT)</strong> , surge de la fusión de experticias de un grupo de profesionales del área de Tecnología de Información, con un combinado en experiencia de más de 35 años.</p>
                </div>
                <div class="container_content_servicess">
                    <img style="display: inline-block; margin-left: 18px" class="label_hide_nosotros" src="static/images/nosotros_com.png" />
                    <p class="text_nosotros">La combinación de experiencias en el campo de Sistemas de Información y en el campo de Infraestructura crea la plataforma ideal para ofrecer las Mejores Prácticas en Tecnología de Información, orientadas al soporte a cliente, diseño, desarrollo, implantación y proyectos en ambas áreas; asegurando así el crecimiento, tanto de nuestros clientes, como de nuestra empresa.</p>
                    <img style="display: inline-block; margin-left: 18px" class="label_hide2_nosotros" src="static/images/nosotros_com.png" />
                </div>
                <div class="container_content_servicess" style="padding-bottom: 30px;">
                    <a href="contactenos.php" class="nosotros_contactenos" ><strong>CONTACTENOS</strong></a>
                </div>
            </div>
        </div>
